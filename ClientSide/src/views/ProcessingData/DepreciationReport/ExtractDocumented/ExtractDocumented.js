      ...
      <div className="animated fadeIn">
         <Row>
          <Col xs="12" md="12">
            <Card>
              <CardHeader>
                <strong>Extract Report of Documented Depreciations Values : </strong> (by company) 
              </CardHeader>
              <CardBody>
        ...
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> <strong>Report of Documented Depreciations Values: </strong>(described above) 
              </CardHeader>
              <CardBody>
