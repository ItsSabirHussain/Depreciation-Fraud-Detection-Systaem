      ...
      <div className="animated fadeIn">
         <Row>
          <Col xs="12" md="12">
            <Card>
              <CardHeader>
                <strong>Generate Comparison Report of Depreciation Values : </strong> (according to extracted or provided rates) 
              </CardHeader>
              <CardBody>
        ...
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-align-justify"></i> <strong>Comparison Report of Depreciation Values: </strong>(according to extracted or provided rates) 
              </CardHeader>
              <CardBody>
