...
const localdbAddress = "mongodb://127.0.0.1/image-store";
mongoose
  .connect(process.env.MONGODB_URI || localdbAddress, {
...
app.post("/getfiledata", function(req, res) {
  ...
  File.findOne({ CompanyName: req.body.CompanyName, Date: req.body.date }).then(
    file => {
      if (file) {
