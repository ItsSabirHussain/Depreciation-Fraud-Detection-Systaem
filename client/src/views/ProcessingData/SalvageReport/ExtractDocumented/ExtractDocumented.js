...
class ExtractDocumented extends Component {
  ...
  onClick() {
    ...
    const url = "http://localhost:5000/extdocsal";
    axios
      .post(url, {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" md="12">
            <Card>
              <CardHeader>
                <strong>Extract Report of Documented Salvage Values : </strong>{" "}
                (by company)
              </CardHeader>
              <CardBody>
                <Form
          ...
          <Col>
            <Card>
              <CardHeader>
                ...
                <strong>Report of Documented Salvage Values: </strong>(described
                above)
              </CardHeader>
